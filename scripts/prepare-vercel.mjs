...
// intentionally not properties of window, so the persistence adapter cannot
// inspect the live model. `var` preserves the same runtime semantics here while
// making window.DB available to the adapter.
