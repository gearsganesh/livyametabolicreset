...
// The renderer keeps its existing FILES interface, but production replaces
// its implementation with Supabase Storage after the app initializes.
...
html = html.replace(/<script[^>]+src=["'](?:https:\/\/cdn\.jsdelivr\.net\/npm\/@supabase\/supabase-js@2|\/?supabase-config\.js|\/?supabase-bridge\.js|\/?supabase-persistence\.js|\/?supabase-storage\.js|\/?supabase-messages\.js|\/?production-hardening\.js|\/?production-runtime\.js)["'][^>]*><\/script>\s*/gi, '');
